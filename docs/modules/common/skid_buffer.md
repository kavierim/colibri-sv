...
RTL notes: Skid buffer to propagate back-pressure. Use this if low latency is needed, use pipeline buffer for better performance and full decoupling. Release log: - 0.1 first release
