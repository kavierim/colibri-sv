...
RTL notes: 8b/10b Decoder lookup table (ROM)-based 8b/10b decoder. The lookup table approach guarantees minimal resource usage and short combinatorial paths. copyright CERN 2025 Changelog: - 0.2 reformatted for Vivado to infer primitives Library entity. Lint alongside verilator/wave0_elab.sv reports multiple tops.
