...
// Packet-shape checks for be_remove_trail, translated from fv/misc/be_remove_trail.psl.

`timescale 1ns/1ps

module be_remove_trail_sva #(
...
bind be_remove_trail be_remove_trail_sva be_remove_trail_sva_i (.*);
