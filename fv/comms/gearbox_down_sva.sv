...
// PSL gearbox_down.psl, bound to gearbox with g_INPUT_WIDTH=12 and g_OUTPUT_WIDTH=4.

`timescale 1ns/1ps

module gearbox_down_sva #(
  parameter int g_INPUT_WIDTH = 12,
  parameter int g_OUTPUT_WIDTH = 4
) (
  input logic                        clk_i,
  input logic                        reset_i,
  ...
  if ((g_INPUT_WIDTH == 12) && (g_OUTPUT_WIDTH == 4)) begin : gen_gearbox_down
    logic saw_clk = 1'b0;
