...
// Translated from fv/packet/header_remove.psl.
// The ready-low assume is a formal constraint; see header_add_sva.sv.

`timescale 1ns/1ps

module header_remove_sva #(
...
bind header_remove header_remove_sva #(
